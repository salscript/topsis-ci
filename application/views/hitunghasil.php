        ...
        <div id="printpa" style="margin-left: 1.5cm;margin-right: 1.5cm;">
            ...
            <table width="100%" >
                ...
                <tr>
                    ...
                    Laporan ini memuat hasil evaluasi dan pemeringkatan supplier.<p>
                         Penilaian dilakukan berdasarkan kriteria tertentu untuk membantu manajemen dalam menentukan mitra kerja terbaik secara objektif.
                        <br><br>
                    </td>
                </tr>
                <tr>
